...
//                holder.itemView.context.startActivity(Intent(holder.itemView.context,EditActivity::class.java).apply {
//                    putExtra("id",note.id)
//                })
//            }else{
//
...
//
        ...
        holder.deleteButton.setOnClickListener{
            ...
            Toast.makeText(holder.itemView.context, note.id.toString(), Toast.LENGTH_SHORT).show()
        }
